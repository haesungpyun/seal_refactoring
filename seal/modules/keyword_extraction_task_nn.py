...
@TaskNN.register("keyword-extraction")
class KeywordExtractionTaskNN(TaskNN):
    def __init__(
        self,
        vocab: Vocabulary,
...
@TaskNN.register("keyword-extraction-text")
class KeywordExtractionTextTaskNN(KeywordExtractionTaskNN):
    def __init__(
        self,
        vocab: Vocabulary,
