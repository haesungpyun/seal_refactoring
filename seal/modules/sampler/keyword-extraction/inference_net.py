...
@Sampler.register("keyword-extraction-inference-net-normalized")
@InferenceNetSampler.register(
    "keyword-extraction-inference-net-normalized",
)
class KeywordExtractionlNormalized(InferenceNetSampler):
    @property
...
@Sampler.register("keyword-extraction-inference-net-normalized-or-sampled")
@InferenceNetSampler.register(
    "keyword-extraction-inference-net-normalized-or-sampled"
)
class KeywordExtractionNormalizedOrSampled(InferenceNetSampler):
    """
...
@Sampler.register("keyword-extraction-inference-net-normalized-or-continuous-sampled")
@InferenceNetSampler.register(
    "keyword-extraction-inference-net-normalized-or-continuous-sampled"
)
class KeywordExtractionNormalizedOrContinuousSampled(KeywordExtractionNormalizedOrSampled):
    """
    Samples during training and normalizes during evaluation.
