...
@Model.register(
    "keyword-extraction-with-infnet",
    constructor="from_partial_objects_with_shared_tasknn",
)
@Model.register(
    "keyword-extraction", constructor="from_partial_objects"
)
...
class KeywordExtraction(ScoreBasedLearningModel):
    def __init__(
        self,
        **kwargs: Any,
    ) -> None:
    ...
    def calculate_metrics(  # type: ignore
        ...
        **kwargs: Any,
        ...
        self._accuracy(y_hat_n, labels_indices)
...
@Model.register(
    "keyword-extraction-with-scorenn-evaluation",
    constructor="from_partial_objects",
)
@Model.register(
    "keyword-extraction-with-infnet-and-scorenn-evaluation",
    constructor="from_partial_objects_with_shared_tasknn",
)
class KeywordExtractionWithScoreNNEvaluation(KeywordExtraction):
    def __init__(
        self,
        **kwargs: Any,
    ) -> None:
